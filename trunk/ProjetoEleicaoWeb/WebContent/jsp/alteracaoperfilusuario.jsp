...
<body>
	...
	<table width="100%">
		...
		<tr>
			...
			<td>
				<input type="text" id="<%=ServletPerfilUsuario.ID_REQ_DESCRICAO_PERFIL_USUARIO%>" name="<%=ServletPerfilUsuario.ID_REQ_DESCRICAO_PERFIL_USUARIO%>" value="<%=perfilUsuario.getDescricao()%>" ></input>
			</td>
		</tr>
	</table>
	<table width="100%">
